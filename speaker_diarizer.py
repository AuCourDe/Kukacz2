...
# Monkey-patch dla torch.load - wymusza weights_only=False dla kompatybilności
# z checkpointami pyannote (naprawia błąd "persistent id instruction")
_original_torch_load = torch.load

@functools.wraps(_original_torch_load)
def _patched_torch_load(*args, **kwargs):
    # Wymuszenie weights_only=False jeśli nie podano explicite
